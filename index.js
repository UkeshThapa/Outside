...
const Assignments = ["CSS ASSIGNMENTS", "HTML ASSIGNMENTS", "FIGMA ASSIGNMENTS","SCSS ASSIGNMENTS","BOOTSTRAP ASSIGNMENTS","FINAL FRONTEND ASSIGGNMENT"];
const links = ['CSS','HTML','figma','SCSS','Bootstrap5','Final_project(Front_end)/dist']

...
function section_1_metabox_callback( $post ) {
    ...
    $section_1_name = get_post_meta($post->ID, "section_1_name", true);
    ...
    <tr>
        ...
        <td><input type="text" name="name" id="name" value="<?php if ( isset ( $section_1_name ) ) echo $section_1_name; ?>" /></td>
    </tr>
	<tr>
        <td>Image1</td>
        <td>
...
function section_1_save_metabox_data($post_id, $post) {
    ...
    if (isset($_POST['name'])) {
        $section_1_name = sanitize_text_field($_POST['name']);
    } 
    ...
    update_post_meta($post_id, "section_1_name", $section_1_name);
